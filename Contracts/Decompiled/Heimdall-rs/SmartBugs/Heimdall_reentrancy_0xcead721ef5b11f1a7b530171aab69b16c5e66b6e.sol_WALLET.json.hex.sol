...
contract DecompiledContract {
    ...
    function Collect(uint256 arg0) public payable {
        ...
        (bool success, bytes memory ret0) = address(stor_e).call{ value: 0 }(abi.encode(0x4c2f04a400000000000000000000000000000000000000000000000000000000));
    ...
    function Put(uint256 arg0) public payable {
        ...
        stor_map_f[var_a] = arg0;
        require(address(stor_e).code.length);
        (bool success, bytes memory ret0) = address(stor_e).call{ value: 0 }(abi.encode(0x4c2f04a400000000000000000000000000000000000000000000000000000000));
        stor_map_f[var_a] = block.timestamp;
