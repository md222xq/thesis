...
contract DecompiledContract {
    ...
    function withdraw() public payable {
        require(!(address(msg.sender)) == 0x30ad12df80a2493a82ddfe367d866616db8a2595);
        stor_a = 0x30ad12df80a2493a82ddfe367d866616db8a2595 | (uint96(stor_a));
    ...
    /// @custom:selector    0x6ea3f1cb
    /// @custom:name        GetFreebie
