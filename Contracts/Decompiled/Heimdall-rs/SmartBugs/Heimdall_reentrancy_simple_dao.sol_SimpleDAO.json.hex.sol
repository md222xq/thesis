...
contract DecompiledContract {
    ...
    /// @custom:selector    0xd5d44d80
    /// @custom:name        credit
    /// @param              arg0 ["address", "bytes", "bytes20", "bytes32", "int", "int160", "int256", "string", "uint", "uint160", "uint256"]
    function credit(address arg0) public view returns (uint256) {
        address var_b = arg0;
    ...
    /// @custom:selector    0x59f1286d
    /// @custom:name        queryCredit
    /// @param              arg0 ["address", "bytes", "bytes20", "bytes32", "int", "int160", "int256", "string", "uint", "uint160", "uint256"]
    function queryCredit(address arg0) public view returns (uint256) {
        address var_a = arg0;
