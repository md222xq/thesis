...
contract DecompiledContract {
    ...
    function Unresolved_a9059cbb(address arg0, bytes memory arg1) public returns (bool) {
        ...
        var_a = msg.sender;
        if (!arg1 > stor_map_b[var_a]) {
            var_a = msg.sender;
            stor_map_b[var_a] = stor_map_b[var_a] - arg1;
            var_a = arg0;
            if (!(stor_map_b[var_a] + arg1) < stor_map_b[var_a]) {
                var_a = arg0;
                stor_map_b[var_a] = stor_map_b[var_a] + arg1;
        ...
        if ((stor_map_b[var_a]) == 0x01) {
            ...
            if (!arg2 > stor_map_b[var_a]) {
                ...
                if (!(stor_map_b[var_a] + arg2) < stor_map_b[var_a]) {
                    ...
                    stor_map_b[var_a] = stor_map_b[var_a] + arg2;
                    var_a = msg.sender;
                    require((bytes1(stor_map_b[var_a])) == 0x01);
                    var_a = msg.sender;
                    stor_map_b[var_a] = stor_map_b[var_a] - arg2;
    ...
    function Unresolved_791f83eb(address arg0, bool arg1) public {
        ...
        address var_a = arg0;
        stor_map_b[var_a] = (arg1) | (uint248(stor_map_b[var_a]));
    }
    ...
    function Unresolved_ff9913e8(address arg0) public view returns (bool) {
        address var_b = arg0;
        address var_c = !(!bytes1(stor_map_g[var_b]));
        return var_c;
    }
