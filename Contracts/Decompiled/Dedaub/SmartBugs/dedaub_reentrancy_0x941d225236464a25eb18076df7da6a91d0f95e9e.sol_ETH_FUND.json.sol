...
function CashOut(uint256 varg0) public payable { 
    v0 = v1 = varg0 <= _balances[msg.sender];
    if (!bool(varg0 > _balances[msg.sender])) {
        v0 = block.number > stor_3;
    }
    if (v0) {
        ...
        if (v2) {
            ...
            require(bool(stor_2_0_19.code.size));
            v3 = stor_2_0_19.AddMessage(msg.sender, varg0, 'CashOut').gas(msg.gas);
