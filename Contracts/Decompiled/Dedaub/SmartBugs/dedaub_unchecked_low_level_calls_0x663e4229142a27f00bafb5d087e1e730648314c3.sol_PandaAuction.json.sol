...
struct_1418[] _totalSupply; // STORAGE[0x7]
...
function bidOnSiringAuction(uint256 varg0, uint256 varg1) public payable { 
    ...
    v1 = 0x4ce6(varg0, 3 * varg0 + keccak256(7), varg1, 3 * varg1 + keccak256(7));
    require(bool(v1));
...
function breedWithAuto(uint256 varg0, uint256 varg1) public payable { 
    ...
    while (1) {
        ...
        if (uint32(MEM[160 + v6]) != 0) {
            // Unknown jump to Block 0x52320x45c2B0x130c. Refer to 3-address code (TAC);
        }
        v12 = uint64(MEM[64 + v6]) <= uint64(block.number);
        // Unknown jump to Block {'0x47acB0x130c', '0x4947B0x130c'}. Refer to 3-address code (TAC);
        require(bool(v12));
        assert(bool(varg1 < _totalSupply.length));
    ...
    require(bool(v12));
    v21 = 0x4ce6(varg1, v0, varg0, 3 * varg0 + keccak256(7));
    require(bool(v21));
    assert(bool(varg0 < _totalSupply.length));
...
function 0x1939(uint256 varg0) private { 
...
function 0x3962(uint256 varg0) private { 
    require(bool(varg0 > 0));
    assert(bool(varg0 < _totalSupply.length));
...
function 0x4ce6(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    if (varg2 != varg0) {
...
function canBreedWith(uint256 varg0, uint256 varg1) public nonPayable { 
    ...
    assert(bool(varg0 < _totalSupply.length));
    assert(bool(varg1 < _totalSupply.length));
    v0 = v1 = 0x4ce6(varg1, 3 * varg1 + keccak256(7), varg0, 3 * varg0 + keccak256(7));
    if (v1) {
