...
function Deposit() public payable { 
    if (msg.value > _minDeposit) {
        ...
        v0 = stor_1_0_19.AddMessage(msg.sender, msg.value, 'Deposit').gas(msg.gas);
...
function CashOut(uint256 varg0) public payable { 
    if (!bool(varg0 > _balances[address(address(msg.sender))])) {
        ...
        if (v0) {
            ...
            require(bool(stor_1_0_19.code.size));
            v1 = stor_1_0_19.AddMessage(msg.sender, varg0, 'CashOut').gas(msg.gas);
