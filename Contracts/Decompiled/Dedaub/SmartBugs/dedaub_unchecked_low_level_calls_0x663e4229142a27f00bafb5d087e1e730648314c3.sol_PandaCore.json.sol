...
struct_1584[] _totalSupply; // STORAGE[0x7]
...
uint256 _newContractAddress; // STORAGE[0x15] bytes 0 to 19
...
function createPanda(uint256[2] varg0, uint256 varg1) public payable { 
    ...
    v1 = 0x6148(_saleAuction, v0, varg0, 0, 0);
    require(bool(_saleAuction.code.size));
...
function init() public nonPayable { 
    ...
    require(bool(address(msg.sender) == _ceoAddress));
    require(_paused);
    require(bool(_totalSupply.length == 0));
    MEM[64] = MEM[64] + 64;
    MEM[MEM[64]] = uint256.max;
    MEM[32 + MEM[64]] = uint256.max;
    _wizzPandaQuota[1] = 100;
    v0 = 0x6148(0, MEM[64], 0, 0, 0);
}
...
function bidOnSiringAuction(uint256 varg0, uint256 varg1) public payable { 
    ...
    v1 = 0x5c2f(varg0, 3 * varg0 + keccak256(7), varg1, 3 * varg1 + keccak256(7));
    require(bool(v1));
    require(bool(_siringAuction.code.size));
...
function giveBirth(uint256 varg0, uint256[2] varg1, uint256[2] varg2) public nonPayable { 
    ...
    if (keccak256(uint256(block.blockhash(block.number - 2)), block.timestamp) % 100 >= v33) {
        ...
        v16 = v40 = 0x6148(address(map_14[varg0]), v15, uint16(v12 + 1), uint32(_totalSupply[varg0].field2 >> 192), varg0);
    }
...
function breedWithAuto(uint256 varg0, uint256 varg1) public payable { 
    ...
    while (1) {
        ...
        if (uint32(MEM[160 + v6]) != 0) {
            // Unknown jump to Block 0x69ef0x5478B0x171d. Refer to 3-address code (TAC);
        }
        v12 = uint64(MEM[64 + v6]) <= uint64(block.number);
        // Unknown jump to Block {'0x57fdB0x171d', '0x5662B0x171d'}. Refer to 3-address code (TAC);
        require(bool(v12));
        assert(bool(varg1 < _totalSupply.length));
    ...
    require(bool(v12));
    v21 = 0x5c2f(varg1, v0, varg0, 3 * varg0 + keccak256(7));
    require(bool(v21));
    assert(bool(varg0 < _totalSupply.length));
...
function 0x1ef9(uint256 varg0) private { 
...
function () public payable { 
    v0 = v1 = msg.sender == _saleAuction;
    if (msg.sender != _saleAuction) {
        v0 = v2 = msg.sender == _siringAuction;
    }
    require(bool(v0));
}
...
function 0x46f6(uint256 varg0) private { 
    require(bool(varg0 > 0));
    assert(bool(varg0 < _totalSupply.length));
...
function 0x5c2f(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    if (varg2 != varg0) {
...
function getPanda(uint256 varg0) public nonPayable { 
    MEM[(MEM[64]) len 64] = this.code[this.code.size len 64];
    assert(bool(varg0 < _totalSupply.length));
    v0 = v1 = 0 + (3 * varg0 + keccak256(7));
    v2 = v3 = MEM[64];
    if (2) {
        do {
            MEM[v2] = STORAGE[v0];
    ...
    v4 = v5 = 0;
    while (v4 < 64) {
        MEM[288 + MEM[64] + v4] = MEM[v3 + v4];
        v4 = v4 + 32;
    }
    return bool(uint32(uint32(_totalSupply[varg0].field2 >> 192)) != 0), bool(uint64(uint64(_totalSupply[varg0].field2 >> 64)) <= block.number), uint16(_totalSupply[varg0].field2 >> 224), uint64(_totalSupply[varg0].field2 >> 64), uint32(_totalSupply[varg0].field2 >> 192), uint64(_totalSupply[varg0].field2), uint32(_totalSupply[varg0].field2 >> 128), uint32(_totalSupply[varg0].field2 >> 160), uint16(_totalSupply[varg0].field2 >> 240);
}

function 0x6148(uint256 varg0, struct(2) varg1, uint16 varg2, uint32 varg3, uint32 varg4) private { 
    v0 = new struct(2);
...
function unpause() public nonPayable { 
    require(bool(address(msg.sender) == _ceoAddress));
    require(_paused);
    require(bool(_saleAuction != address(0x0)));
    require(bool(_siringAuction != address(0x0)));
    require(bool(_geneScience != address(0x0)));
    require(bool(_newContractAddress == address(0x0)));
    require(bool(address(msg.sender) == _ceoAddress));
    require(_paused);
    _paused = 0;
}
...
function canBreedWith(uint256 varg0, uint256 varg1) public nonPayable { 
    ...
    assert(bool(varg0 < _totalSupply.length));
    assert(bool(varg1 < _totalSupply.length));
    v0 = v1 = 0x5c2f(varg1, 3 * varg1 + keccak256(7), varg0, 3 * varg0 + keccak256(7));
    if (v1) {
...
function withdrawBalance() public nonPayable { 
    require(bool(address(msg.sender) == _cfoAddress));
    if ((address(this)).balance > (_pregnantPandas + 1) * _autoBirthFee) {
        v0 = _cfoAddress.call().value((address(this)).balance - (_pregnantPandas + 1) * _autoBirthFee).gas(!((address(this)).balance - (_pregnantPandas + 1) * _autoBirthFee) * 2300);
    }
}
...
function setNewAddress(address varg0) public nonPayable { 
    require(bool(address(msg.sender) == _ceoAddress));
    require(_paused);
    _newContractAddress = varg0;
